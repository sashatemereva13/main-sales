export const UI_COPY = {
  fr: {
    nav: {
      ...
      enterDebug: "Entrer en mode debug",
      exitDebug: "Quitter le mode debug",
    ...
    intro: {
      ...
      subtitle: "Studio de web design immersif",
      startQuiz: "Commencer le quiz",
      ctaMeta: "3 min • recommandation personnalisée",
  ...
  en: {
    ...
    intro: {
      ...
      available: "Available",
      subtitle: "Immersive web design studio",
      startQuiz: "Start Quiz",
      ctaMeta: "3 min • personalized recommendation",
    ...
    quiz: {
      ...
      submitErrorUnavailable:
        "Your recommendation cannot be sent right now.",
      ...
      deliveryNote:
        "You can go back and adjust an answer before sending.",
